...
/**
 * Created by Jungle on 2018/12/7.
 */

public class LiveRecyclerBehavior extends CoordinatorLayout.Behavior<TextView> {
    ...
    public LiveRecyclerBehavior() {
    }

    public LiveRecyclerBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
